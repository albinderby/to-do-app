  ...
  return new Promise((resolve, reject) => {
    ...
    request.onupgradeneeded = (event) => {
      ...
      if (!db.objectStoreNames.contains(STORE_NAMES.PROJECT)) {
        let objectStore = db.createObjectStore(STORE_NAMES.PROJECT, {
          keyPath: "id",
          autoIncrement: true,
        });
      ...
      if (!db.objectStoreNames.contains(STORE_NAMES.TO_DO)) {
        let objectStore = db.createObjectStore(STORE_NAMES.TO_DO, {
          keyPath: "list_no",
          autoIncrement: true,
        });
        objectStore.createIndex("projectIdINdex", "projectId", {
          unique: false,
        });
      }
